...
Radius Networks also sells [active iBeacons](http://www.radiusnetworks.com/ibeacon-services.html) suitable for deployment.   For testing purposes, an iBeacon can be made out of an any iOS7 device that supports Low Energy Bluetooth using
